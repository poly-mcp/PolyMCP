...
### UnifiedPolyAgent v2.0 (backward compatible)
- Budget control: wall time / token caps / tool call limits
- Observability: structured logs, metrics, trace IDs
- Security: auto-redaction, allow/deny lists, schema validation
- Resilience: retries, circuit breakers, rate limiting
- Performance: async HTTP + caching + bounded memory
